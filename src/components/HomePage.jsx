  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-orange-100 via-slate-50 to-slate-50 opacity-50" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <h1 className="text-6xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-red-600">
              Crafting Culinary
              <br />
              Experiences
            </h1>
            ...
            <div className="flex gap-4 justify-center">
              <button className="bg-orange-600 text-white px-8 py-3 rounded-full font-medium hover:bg-orange-700 transition-colors">
                Book Now
              </button>
              <button className="border-2 border-orange-600 text-orange-600 px-8 py-3 rounded-full font-medium hover:bg-orange-50 transition-colors">
                View Menu
              </button>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span>123 Culinary Street, Hyderabad, India</span>
                </div>
                <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span>contact@mahaspice.com</span>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-6">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-600 focus:border-transparent outline-none"
              />
              <button className="w-full bg-orange-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-orange-700 transition-colors">
                Send Message
              </button>
            </form>
          </div>
...
//                 className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none"
//               />
//               <button className="w-full bg-green-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors">
//                 Send Message
//               </button>
//             </form>
//           </div>
